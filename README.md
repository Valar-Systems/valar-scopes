...
**We do not collect behavioural data, and that is a decision rather than a gap.** Nothing reports which screen you look at, how often you tap, how long the device is watched, which aircraft you open, or whether you use it at all. It would be easy to add — the device already makes a request we could attach counters to — and we have decided not to, permanently. Two reasons. It is a device in your home, and a screen you glance at over your morning coffee is not our business. And practically: at this scale we learn far more by emailing ten owners and asking than by instrumenting all of them, so the data would cost your privacy and buy us very little. **"Blipscope doesn't track how you use it" is a sentence we intend to keep being able to say.**
