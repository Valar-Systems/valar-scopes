...
| Beat | Direction |
|---|---|
| **Liftoff** | **the one shot from the ground.** A fixed side-on silo camera: the vehicle **fully below grade** before first motion, hot-launching out of the mouth, billowing smoke, camera shake decaying over ~2.2 s, and a glow in the hole that is the only thing on screen between ignition and first motion. It is **its own beat**, not a camera split inside stage 1 — burying it there would average its cost into a beat with 50 s of cheap chase-cam, put the most iconic moment in the sequence out of reach of tap/swipe/hold, and force a refactor the first time §7 wants liftoff separately gated. *Added 2026-08-06.* |
