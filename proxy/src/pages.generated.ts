...
<h2 id="problems">Troubleshooting</h2>
    ...
    <div class="fix">
      ...
      <p><strong>On a phone:</strong> press and hold the picture and choose
         <em>Save to Photos</em> (or <em>Download image</em>). On a desktop there
         is a <em>Save image</em> button; your browser may ask you to confirm,
         so choose <em>Keep</em>.</p>
